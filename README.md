...
-	A modernized, efficient switch mode power supply tha utilizes 4x AA batteries. Testing shows that playing with NiMH AA batteries can yield more than 17 hours of gameplay at normal settings (AKA, the way I normally play it - maximum brightness and headphones). 
